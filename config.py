...
class Config(object):
    ...
    BOT_PWD = os.environ.get("BOT_PASSWORD", "aditya")
    LOGGED_USER = []
    DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://tryoutbothai:botno2@cluster1.d0w5i.mongodb.net/?retryWrites=true&w=majority&appName=Cluster1")
